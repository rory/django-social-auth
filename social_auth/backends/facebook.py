...
class FacebookBackend(OAuthBackend):
    ...
    def extra_data(self, user, uid, response, details):
        """Make a Facebook API call to see what permissions we have"""
        ...
        if 'access_token' in extra_data:
            permissions_details = simplejson.loads(urlopen("https://graph.facebook.com/me/permissions?access_token="+extra_data['access_token']).read())
